...
function Navbar() {
    ...
    return (
        <div className="h-[100px] p-10 px-16 flex justify-between w-full" >
            <motion.div initial={{y: -60, opacity: 0}} whileInView={{y: 0, opacity: 1}}  transition={{duration: 2}} className="flex w-1/2 gap-4 items-center">
            ...
            <motion.div initial={{y: -60, opacity: 0}} whileInView={{y: 0, opacity: 1}}  transition={{duration: 2}} className="flex items-center gap-10">
                <WalletButton/>
            </motion.div>
        </div>
    )
